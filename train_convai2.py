...
def main():
    ...
    # 初始化tokenizer
    tokenizer = GPT2Tokenizer(args.vocab_path+'vocab.json', args.vocab_path+'merges.txt',
    ...
    train_list, test_list = train_test_split(data_list, test_size=0.01, random_state=1)
    # 开始训练
